...
class TestCaseSorting(unittest.TestCase):
    ...
    def testSort(self):
        pass
        self.assertEqual(sortA([43,6,3,434,324,434,342]), [3, 6, 43, 324, 342, 434, 434])

    def testSortReverse(self):
        pass
        self.assertEqual(sortA([43, 6, 3, 434, 324, 434, 342], reverse=True), [434, 434, 342, 324, 43, 6, 3])

    def testSortKey(self):
        self.assertEqual(sortA([43, 6, 3, 434, 324, 434, 342], key=lambda x: -x), [434, 434, 342, 324, 43, 6, 3])

    def testSortCmp(self):
        self.assertEqual(sortA([43, 6, 3, 434, 324, 434, 342], cmp=lambda x, y: x >= y), [434, 434, 342, 324, 43, 6, 3])
